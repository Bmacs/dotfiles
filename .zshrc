...
#PS1="%B%{$fg[red]%}%n%{$reset_color%}@%{$fg[blue]%}%m%{$reset_color%}:%{$fg[cyan]%}%~%{$reset_color%}$%b "
PS1="%B%{$fg[red]%}[%{$fg[green]%}%n%{$reset_color%}@%{$fg[blue]%}%m%{$reset_color%}:%F{94}%~%{$fg[red]%}]%F{10}$%b "

#PS1="%B%{$fg[red]%}[%{$fg[green]%}%n%{$reset_color%}@%{$fg[blue]%}%m%{$reset_color%}:%{$fg[cyan]%}%~%{$fg[red]%}]%{$reset_color%}$%b "
#PS1="%B%F{red}|%F{green}%n%F{cyan}@%F{blue}%m%F{magenta}%~%F{red}|%F{black}$:%b "
